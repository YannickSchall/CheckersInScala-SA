...
class Tui(controller: ControllerInterface) extends Reactor {
  ...
  def tuiEntry(inputSens: String): Unit = {
    ...
    args(0) match {
      ...
      case "DBSAVE" => controller.dbsave(); print("Progress saved\n")
      case "LOAD" => controller.load(); print("Progress loaded\n")
      case "DBLOAD" => controller.dbload(); print("Progress loaded\n")
      ...
      case "HELP" =>
        ...
        print("\u001B[32mdbsave\u001B[0m: Saves the current state of the game in a database. It can be loaded at a later point using \"\u001B[32mdbload\u001B[0m\".\n")
        print("\u001B[32mload\u001B[0m: Loads a state of the game that was saved beforehand using \"\u001B[32msave\u001B[0m\".\n")
        print("\u001B[32mload\u001B[0m: Loads a state of the game that was saved beforehand using \"\u001B[32mdbsave\u001B[0m\".\n")
